...
def main(apk_path: Path, package_output_path: Path):
    ...
    device_weihgt_dir = "/storage/emulated/0/Android/data/com.example.smsdetection/files/"
    ...
    for model_weight_dir in (package_output_path / "bundle").iterdir():
        if model_weight_dir.is_dir():
            ...
            src_path = dst_path
            dst_path = "/storage/emulated/0/Android/data/com.example.smsdetection/files/"
