...
class EngineState {
    ...
    suspend fun chatCompletion(
        ...
        Log.d("DEBUG", "chatCompletion: enter")
        val json = Json { encodeDefaults = true }
//        Log.d("DEBUG", "chatCompletion: before encodeToString")
        val jsonRequest = json.encodeToString(request)
//        val jsonRequest = request.toJsonString()
        Log.d("DEBUG", "chatCompletion: after encodeToString $jsonRequest")
...
//        Log.d("DEBUG", "chatCompletion: before chatCompletion")
        jsonFFIEngine.chatCompletion(jsonRequest, requestID)
        Log.d("DEBUG", "chatCompletion: out")
...
class Completions(
    ...
    suspend fun create(
        ...
        Log.d("DEBUG", "create: ChatCompletionRequest")
        val request = ChatCompletionRequest(
            messages = messages,
            model = model,
